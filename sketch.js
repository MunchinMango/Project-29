...
function setup(){
    ...
    box8 = new Box (520,360,30,40);
    box9 = new Box (550,360,30,40);
    box10 = new Box (580,360,30,40);
    box11 = new Box (610,360,30,40);
    box12 = new Box (640,360,30,40);
    box13 = new Box (670,360,30,40);

    
    box14 = new Box (530,320,30,40);
    box15 = new Box (560,320,30,40);
    box16 = new Box (590,320,30,40);
    box17 = new Box (620,320,30,40);
    box18 = new Box (650,320,30,40);

    
    box19 = new Box (540,280,30,40);
    box20 = new Box (570,280,30,40);
    box21 = new Box (600,280,30,40);
    box22 = new Box (630,280,30,40);

    
    box23 = new Box (550,240,30,40);
    box24 = new Box (580,240,30,40);
    box25 = new Box (610,240,30,40);

    
    box26 = new Box (560,200,30,40);
    box27 = new Box (590,200,30,40);
    ...
    stand1 = new Ground (600,500,250,10);
    stand2 = new Ground (1000,300,180,10);
